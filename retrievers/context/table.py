...
from retrievers.context.base import Context, HydratedAttr, requires_hydration
from retrievers.types import Field
...
class TableFile(BaseTable):
    ...
    @classmethod
    def from_file_store(
        cls, file_ref: str, file_store: FileStore, **kwargs
    ) -> "TableFile":
